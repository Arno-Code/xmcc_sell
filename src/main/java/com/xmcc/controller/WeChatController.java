...
public class WeChatController {
    ...
    public void getCode(@RequestParam("code") String code){
        log.info("进入回掉方法：当前用户授权码（code）为：{}",code);
        String url = "https://api.weixin.qq.com/sns/oauth2/access_token?appid=wxcec0b9e65c084712&secret=05a7e861c1985ced86af77fb8f7163bc&code="
